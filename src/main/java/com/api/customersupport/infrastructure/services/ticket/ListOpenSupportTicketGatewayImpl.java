...
public class ListOpenSupportTicketGatewayImpl implements ListOpenSupportTicketsGateway {
    // Dependency Injection
    private final SupportTicketRepository supportTicketRepository;
    private final SupportTicketMapper supportTicketMapper;

    public ListOpenSupportTicketGatewayImpl(SupportTicketRepository supportTicketRepository,
