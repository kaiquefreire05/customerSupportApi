...
@Service
public class FindFeedbackByIdGatewayImpl implements FindFeedbackByIdGateway {

    //Dependency injection
    private final FeedbackMapper feedbackMapper;
    private final FeedbackEntityRepository feedbackEntityRepository;

    public FindFeedbackByIdGatewayImpl(FeedbackMapper feedbackMapper, FeedbackEntityRepository feedbackEntityRepository) {
