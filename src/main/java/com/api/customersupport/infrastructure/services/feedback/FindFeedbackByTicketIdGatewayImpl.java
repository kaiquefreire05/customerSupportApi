...
public class FindFeedbackByTicketIdGatewayImpl implements FindFeedbackByTicketIdGateway {
    // Dependency injection
    private final FeedbackMapper feedbackMapper;
    private final FeedbackEntityRepository feedbackEntityRepository;

    public FindFeedbackByTicketIdGatewayImpl(FeedbackMapper feedbackMapper
